...
public final class Camera2UseCaseConfigFactory implements UseCaseConfigFactory {
    ...
    public Config getConfig(
        ...
        int targetRotation;
        try {
            targetRotation = mDisplayInfoManager.getMaxSizeDisplay().getRotation();
        } catch (Exception e) {
            int displayLength = mDisplayInfoManager.getDisplayLength();
            CameraLog.rotationErr(displayLength, e);
            targetRotation = 1;
        }
